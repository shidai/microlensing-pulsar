...
double g1 (double *k, size_t dim, void *params)
{
    ...
    vszfunc=(1.0/(sqrt(2.0*3.1415926)*sigma_vsz))*exp(-0.5*(vsz*vsz)/(sigma_vsz*sigma_vsz));
        ...
        F=2.77*pow(10.0,-8.0)*pow(k[0],-6.0)*k[0]*k[0]*cos(b)*pnum*exp(-rds)*p_disk*(Deff)*(sqrt(M)*mfunc)*(v*vdxfunc*vdyfunc*vdzfunc*vsxfunc*vsyfunc*vszfunc)*1.02*pow(10.0,-9.0)/4.3656;
    }
...
double g2 (double *k, size_t dim, void *params)
{
    ...
    // delta_func
        ...
        F=2.77*pow(10.0,-8.0)*pow(k[0],-6.0)*k[0]*k[0]*cos(b)*pnum*exp(-rds)*pnum2*exp(-rds2)*(Deff)*(sqrt(M)*mfunc)*(v*vdxfunc*vdyfunc*vdzfunc*vsxfunc*vsyfunc*vszfunc)*1.02*pow(10.0,-9.0)/4.3656;
    }
...
double g1d (double *k, size_t dim, void *params)
{
    ...
    {
        p_disk_s=pow(k[0],-6.0)*(p0/itad)*exp(-(rd-r0)/H)*((1.0-beta)*pow(cosh(zd/(itad*h1)),-2.0)+beta*exp(-fabs(zd)/(itad*h2)));  // :disk
    }
...
{   
    ...
    vszfunc=(1.0/(sqrt(2.0*3.1415926)*sigma_vsz))*exp(-0.5*(vsz*vsz)/(sigma_vsz*sigma_vsz));
        ...
        F=2.77*pow(10.0,-8.0)*pow(k[0],-6.0)*k[0]*k[0]*cos(b)*pnum*exp(-rds)*p_pulsar*(Deff)*(sqrt(M))*(v*vdxfunc*vdyfunc*vdzfunc*vsxfunc*vsyfunc*vszfunc)*1.02*pow(10.0,-9.0);
    }
...
{   
    ...
    {
        p_disk=pow(k[0],-6.0)*(p0/ita)*exp(-(rdd-r0)/H)*((1.0-beta)*pow(cosh(zdd/(ita*h1)),-2.0)+beta*exp(-fabs(zdd)/(ita*h2)));  // :disk
    }
...
{
    double galaxy,ratio,ns;
    
    // all stars, disk to bulge
    // positive
    double res,err;

    double xl[11]={4.5,0.0,0.03,-100.0,-150.0,-100.0,-550.0,-450.0,-350.0,-3.1415926, -0.5*3.1415926};
    double xu[11]={11.5,11.5,120.0,100.0,150.0,100.0,550.0,450.0,350.0,3.1415926,0.5*3.1415926};
    ...
    double xl2[11]={4.5,4.5,0.03,-550.0,-450.0,-350.0,-550.0,-450.0,-350.0,-3.1415926, -0.5*3.1415926};
    double xu2[11]={11.5,11.5,120.0,550.0,450.0,350.0,550.0,450.0,350.0,3.1415926, 0.5*3.1415926};
    ...
    double xld[11]={0.0,0.0,0.03,-100.0,-150.0,-100.0,-100.0,-150.0,-100.0,-3.1415926, -0.5*3.1415926};
    double xud[11]={11.5,11.5,120.0,100.0,150.0,100.0,100.0,150.0,100.0,3.1415926, 0.5*3.1415926};
    ...
    //double xl2[5]={3.0,3.0,0.03,-800.0,-800.0};
    //double xu2[5]={13.0,13.0,120.0,800.0,800.0};
    double xl2d[11]={0.0,4.5,0.03,-550.0,-450.0,-350.0,-100.0,-150.0,-100.0,-3.1415926, -0.5*3.1415926};
    double xu2d[11]={11.5,11.5,120.0,550.0,450.0,350.0,100.0,150.0,100.0,3.1415926, 0.5*3.1415926};
    ...
    double xl_x[10]={4.5,0.0,-2000.0,-2000.0,-2000.0,-550.0,-450.0,-350.0,-3.1415926, -0.5*3.1415926};
    double xu_x[10]={11.5,11.5,2000.0,2000.0,2000.0,550.0,450.0,350.0,3.1415926, 0.5*3.1415926};
    ...
    double xl_xd[10]={0.0,0.0,-2000.0,-2000.0,-2000.0,-100.0,-150.0,-100.0,-3.1415926, -0.5*3.1415926};
    double xu_xd[10]={11.5,11.5,2000.0,2000.0,2000.0,100.0,150.0,100.0,3.1415926, 0.5*3.1415926};
    ...
    double xly[11]={4.5,0.0,40.0,-100.0,-150.0,-100.0,-550.0,-450.0,-350.0,-3.1415926, -0.5*3.1415926};
    double xuy[11]={11.5,11.5,120.0,100.0,150.0,100.0,550.0,450.0,350.0,3.1415926,0.5*3.1415926};

    const gsl_rng_type *Ty;
    gsl_rng *ry;

    gsl_monte_function Gy={&g1,11,0};

    size_t callsy=50000000;
    ...
    //double xl2[5]={3.0,3.0,0.03,-800.0,-800.0};
    //double xu2[5]={13.0,13.0,120.0,800.0,800.0};
    double xl2y[11]={4.5,4.5,40.0,-550.0,-450.0,-350.0,-550.0,-450.0,-350.0,-3.1415926, -0.5*3.1415926};
    double xu2y[11]={11.5,11.5,120.0,550.0,450.0,350.0,550.0,450.0,350.0,3.1415926, 0.5*3.1415926};

    const gsl_rng_type *T2y;
    gsl_rng *r2y;

    gsl_monte_function G2y={&g2,11,0};

    size_t calls2y=50000000;
    ...
    double xldy[11]={0.0,0.0,40.0,-100.0,-150.0,-100.0,-100.0,-150.0,-100.0,-3.1415926, -0.5*3.1415926};
    double xudy[11]={11.5,11.5,120.0,100.0,150.0,100.0,100.0,150.0,100.0,3.1415926, 0.5*3.1415926};

    const gsl_rng_type *Tdy;
    gsl_rng *rdy;

    gsl_monte_function Gdy={&g1d,11,0};

    size_t callsdy=50000000;

    Tdy=gsl_rng_default;

    // bh, bulge to disk
    double res2dy,err2dy;

    //double xl2[5]={3.0,3.0,0.03,-800.0,-800.0};
    //double xu2[5]={13.0,13.0,120.0,800.0,800.0};
    double xl2dy[11]={0.0,4.5,40.0,-550.0,-450.0,-350.0,-100.0,-150.0,-100.0,-3.1415926, -0.5*3.1415926};
    double xu2dy[11]={11.5,11.5,120.0,550.0,450.0,350.0,100.0,150.0,100.0,3.1415926, 0.5*3.1415926};

    const gsl_rng_type *T2dy;
    gsl_rng *r2dy;

    gsl_monte_function G2dy={&g2d,11,0};

    size_t calls2dy=50000000;

    T2dy=gsl_rng_default;
    ...
    gsl_monte_vegas_state *sy = gsl_monte_vegas_alloc (11);

    r2y = gsl_rng_alloc (T2y);

    gsl_monte_vegas_state *s2y = gsl_monte_vegas_alloc (11);

    rdy = gsl_rng_alloc (Tdy);

    gsl_monte_vegas_state *sdy = gsl_monte_vegas_alloc (11);

    r2dy = gsl_rng_alloc (T2dy);

    gsl_monte_vegas_state *s2dy = gsl_monte_vegas_alloc (11);
    ...
    //////////////////////////////////////////////////////////////////////////////////////////////
        ...
        gsl_monte_vegas_integrate (&Gy, xly, xuy, 11, 10000, ry, sy, &resy, &erry);

        do
        {
            gsl_monte_vegas_integrate (&Gy, xly, xuy, 11, callsy/5, ry, sy, &resy, &erry);
        }
        while (fabs (gsl_monte_vegas_chisq (sy) - 1.0) > 0.5);

    //////////////////////////////////////////////////////////////////////////////////////////
    ////////////////////////////////////////////////////////////////////////////////////////////

        gsl_monte_vegas_integrate (&G2y, xl2y, xu2y, 11, 10000, r2y, s2y, &res2y, &err2y);

        do
        {
            gsl_monte_vegas_integrate (&G2y, xl2y, xu2y, 11, calls2y/5, r2y, s2y, &res2y, &err2y);
        }
        while (fabs (gsl_monte_vegas_chisq (s2y) - 1.0) > 0.5);

    //////////////////////////////////////////////////////////////////////////////////////////
    ////////////////////////////////////////////////////////////////////////////////////////////

        gsl_monte_vegas_integrate (&Gdy, xldy, xudy, 11, 10000, rdy, sdy, &resdy, &errdy);

        do
        {
            gsl_monte_vegas_integrate (&Gdy, xldy, xudy, 11, callsdy/5, rdy, sdy, &resdy, &errdy);
        }
        while (fabs (gsl_monte_vegas_chisq (sdy) - 1.0) > 0.5);

    //////////////////////////////////////////////////////////////////////////////////////////
    ////////////////////////////////////////////////////////////////////////////////////////////

        gsl_monte_vegas_integrate (&G2dy, xl2dy, xu2dy, 11, 10000, r2dy, s2dy, &res2dy, &err2dy);

        do
        {
            gsl_monte_vegas_integrate (&G2dy, xl2dy, xu2dy, 11, calls2dy/5, r2dy, s2dy, &res2dy, &err2dy);
        }
        while (fabs (gsl_monte_vegas_chisq (s2dy) - 1.0) > 0.5);

    //////////////////////////////////////////////////////////////////////////////////////////
    ////////////////////////////////////////////////////////////////////////////////////////////

        ns = resy+res2y+resdy+res2dy;
        galaxy = res+res2+resd+res2d+res_x+res_xd;
        ratio = ns/galaxy;
        printf ("%e\n", ratio);
    ...
    gsl_monte_vegas_free (sy);

    gsl_rng_free (ry);

    gsl_monte_vegas_free (s2y);

    gsl_rng_free (r2y);

    gsl_monte_vegas_free (sdy);

    gsl_rng_free (rdy);

    gsl_monte_vegas_free (s2dy);
